...
const DEMO_GOALS: Goal[] = [
  { id: '1', user_id: 'demo', title: '10 kg vermek', name: '10 kg vermek', description: 'Yıl sonuna kadar hedef kilo', category: 'health', target_value: 10, current_value: 3, unit: 'kg', deadline: '2026-12-31', status: 'active', created_at: new Date().toISOString() },
  { id: '2', user_id: 'demo', title: 'İngilizce B2 seviyesi', name: 'İngilizce B2 seviyesi', description: 'Cambridge sınavına hazırlık', category: 'education', target_value: 100, current_value: 45, unit: '%', deadline: '2026-09-01', status: 'active', created_at: new Date().toISOString() },
]
